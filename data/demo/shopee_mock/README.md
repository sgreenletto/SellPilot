...
| 文件 | 数据行数 | 主要用途 |
|---|---:|---|
| `products.csv` | 100 | 商品目录、选品基础信息、看板商品指标 |
| `skus.csv` | 260 | SKU、规格、价格与成本 |
| `inventory.csv` | 260 | SKU 库存、预留库存、安全库存与库存状态 |
...
- 每个商品均包含由核心特性、商品类型专属使用场景、可选规格和针对性下单核对提示组成的完整英文描述；生成器与校验器会阻止描述退化为单句占位文本。
